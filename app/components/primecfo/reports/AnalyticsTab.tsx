...
export default function AnalyticsTab() {
  ...
  const { kpis, trends, periodTotals, validation } = data;

  const totalRevenue = periodTotals?.totalRevenue ?? trends.reduce((s, t) => s + t.revenue, 0);

  const totalCosts = periodTotals?.totalCosts ?? trends.reduce((s, t) => s + t.expenses, 0);

  const totalNetIncome = periodTotals?.totalNetIncome ?? trends.reduce((s, t) => s + (t.netIncome ?? 0), 0);

  const periodCount = periodTotals?.periodCount ?? trends.length;
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      {validation && !validation.ok && validation.message ? (
        ...
        <div className="rounded-xl border border-slate-600/40 bg-slate-800/40 px-4 py-3 text-sm text-slate-400">
          ...
          {trends.length === 0 ? (
            ...
            <>
              ...
              <div className="h-64 w-full">
                ...
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  <BarChart data={trends} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                    ...
                    <Bar dataKey="expenses" name="Total Costs" fill="#ef4444" radius={[4, 4, 0, 0]} />
              ...
              <p className="text-xs text-slate-500 mt-3">
                ...
                Total costs include COGS and operating expenses from synced monthly P&amp;L.
          ...
          <div className="space-y-4">
              ...
              <div className="w-full bg-slate-600 rounded-full h-2">
                ...
                <div
                  ...
                  style={{
                    ...
                    width: `${Math.min(100, totalRevenue > 0 ? (totalRevenue / (totalRevenue + totalCosts)) * 100 : 0)}%`,
            ...
            <div>
              ...
              <div className="flex justify-between mb-2">
                ...
                <span className="text-sm font-medium text-slate-300">Total Costs (COGS + OpEx)</span>

                <span className="text-sm font-medium text-red-400">{formatCurrency(totalCosts)}</span>
              ...
              <div className="w-full bg-slate-600 rounded-full h-2">
                ...
                <div
                  ...
                  style={{
                    ...
                    width: `${Math.min(100, totalCosts > 0 ? (totalCosts / (totalRevenue + totalCosts)) * 100 : 0)}%`,
            ...
            <div className="flex justify-between pt-2 border-t border-slate-700/50">
              ...
              <span className="text-sm font-medium text-slate-300">Net Income</span>

              <span className={`text-sm font-semibold ${totalNetIncome >= 0 ? "text-emerald-400" : "text-red-400"}`}>
            ...
            <p className="text-xs text-slate-500">
              ...
              Aggregated from monthly QBO Profit &amp; Loss sync ({periodCount} period
