...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    cardBullets: [
      ...
      "1-hour quarterly advisory meeting with a licensed CPA",
    ],
    features: [
      { label: "QuickBooks Dashboard", included: true },
      { label: "AI Financial Summaries", value: "Weekly" },
      { label: "Cash Flow Forecast", value: "60-day" },
      { label: "Advisory Hours", value: "1 hr/quarter CPA meeting" },
    ],
    cta: "Start Free for 14 Days",
    ctaNote: "14-day free trial · card required",
    ctaKind: "signup",
  ...
  },
  {
    ...
    cardBullets: [
      ...
      "1-hour monthly advisory meeting with a licensed CPA",
    ],
    features: [
      { label: "QuickBooks Dashboard", included: true },
      { label: "Cash Flow Forecast", value: "90-day + scenarios" },
      { label: "Custom Alerts", included: true },
      { label: "Advisory Hours", value: "1 hr/month CPA meeting" },
    ],
    cta: "Start Free for 14 Days",
    ctaNote: "14-day free trial · card required",
    ctaKind: "signup",
...
export const DECISION_HELPERS: DecisionHelper[] = [
  ...
  },
  {
    ...
    desc: "See adds deeper dashboard coverage with the same monthly AI summary and 30-day forecast.",
    tier: "See — $107/mo billed annually ($119 monthly)",
  },
  {
    icon: "users",
    title: "I want a guide",
    desc: "Understand adds weekly summaries, a longer forecast, and a 1-hour quarterly advisory meeting with a licensed CPA.",
    tier: "Understand — $314/mo billed annually ($349 monthly)",
  },
  {
    icon: "building",
    title: "I want a partner",
    desc: "Act layers in scenario planning, alerts, and a 1-hour monthly advisory meeting with a licensed CPA.",
